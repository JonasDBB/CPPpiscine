...
/*   Updated: 2020/08/25 16:00:06 by jonasbb       ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
void	supertrap(void)
{
	SuperTrap	super("Soopah");
	FragTrap	frag("Fragster");
	NinjaTrap	ninja("Nindy");

	frag.rangedAtk("Butt Stallion");
	super.rangedAtk("Butt Stallion");
	ninja.meleeAtk("Wainwright");
	super.meleeAtk("Wainwright");

	super.takeDmg(50);
	super.beRepaired(100);

	super.vaulthunter_dot_exe("lunatic");
